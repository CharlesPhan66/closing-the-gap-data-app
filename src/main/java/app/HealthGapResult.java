...
public class HealthGapResult {
	...
	public HealthGapResult(String lga, String diseaseName, Integer status1_2016, Integer status2_2016, Integer gap_2016, Integer status1_2021, Integer status2_2021, Integer gap_2021) {
		this.lga = lga;
